...
import 'package:atompro/features/customer/notifications/repository/customer_notifications_repository.dart';
import 'package:flutter_riverpod/flutter_riverpod.dart';

final customerNotificationsProvider =
    NotifierProvider<CustomerNotificationsNotifier, NotificationsState>(
  CustomerNotificationsNotifier.new,
);

class CustomerNotificationsNotifier extends Notifier<NotificationsState> {
  @override
  ...
  CustomerNotificationsRepository get _repo =>
      ref.read(customerNotificationsRepositoryProvider);

  // Auto-runs on provider creation to populate the badge count.
